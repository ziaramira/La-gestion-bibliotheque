...
<body>
	<div id="divdiv">
	<h2 id="auteur">Rechercher un Auteur par numéro</h2>
	<form action="auteurResultat.jsp" class="text-center">
		 <div class="col-lg-6">
		    <div class="input-group">
		      <input type="text" class="form-control" name="auteur" placeholder="Entrer le numéro de l'auteur....">
