...
<body>
	<div id="divdiv">
	<h2 id="domaine">Rechercher un livre par Domaine</h2>
	<form action="domaineResultat.jsp" class="text-center">
		 <div class="col-lg-6">
		    <div class="input-group">
		      <input type="text" class="form-control" name="domaine" placeholder="Entrer le  domaine....">
